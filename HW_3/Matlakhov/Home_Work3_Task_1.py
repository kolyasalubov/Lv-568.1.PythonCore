...
lst = zen.split()  # разбивает текст на части
print("count 'better' =", zen.count('better'))  # выводим количество элемента
...
prin = zen.maketrans("i", "&")
print(zen.translate(prin))

print(zen.translate(zen.maketrans("i", "&")))
